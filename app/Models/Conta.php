...
class Conta extends Model
{
    ...
    use HasFactory;
    protected $fillable = ['matricula', 'mes_referencia', 'data_vencimento', 'cod_barras', 'valor', 'ind_pago', 'tipo_contas_id'];


    public function getTipoContas(){
        return $this->belongsTo(TipoContas::class, 'tipo_contas_id');
    }
